document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".input-form-title").forEach((title) => {
        title.addEventListener("input", function () {
            ...
            document.title = `${this.value} - Freedom Questions CLONE`;
    ...
    document
        .querySelector("#customize-theme-btn")
        .addEventListener("click", () => {
            document.querySelector("#customize-theme").style.display = "block";
            document
                .querySelector("#close-customize-theme")
                .addEventListener("click", () => {
                    document.querySelector("#customize-theme").style.display =
                        "none";
                });
            window.onclick = (e) => {
                if (e.target == document.querySelector("#customize-theme"))
                    document.querySelector("#customize-theme").style.display =
                        "none";
            };
        });
    document
        .querySelector("#input-bg-color")
        .addEventListener("input", function () {
    ...
    document
        .querySelector("#input-text-color")
        .addEventListener("input", function () {
            document.querySelectorAll(".txt-clr").forEach((element) => {
    ...
    document.querySelector("#setting-form").addEventListener("submit", (e) => {
        ...
        fetch("edit_setting", {
            ...
            body: JSON.stringify({
                ...
                confirmation_message: document.querySelector(
                    "#comfirmation_message"
                ).value,
                edit_after_submit:
                    document.querySelector("#edit_after_submit").checked,
                allow_view_score:
                    document.querySelector("#allow_view_score").checked,
            }),
        });
        document.querySelector("#setting").style.display = "none";
            ...
            if (document.querySelector(".collect-email"))
                document
                    ...
                    .parentNode.removeChild(
                        document.querySelector(".collect-email")
                    );
        } else {
            if (!document.querySelector(".collect-email")) {
        ...
        if (document.querySelector("#is_quiz").checked) {
            ...
            if (!document.querySelector(".score")) {
                ...
                [
                    ...document.querySelector(".form-navigation").children,
                ].forEach((element) => {
                    element.classList.remove("col-6");
                    element.classList.add("col-4");
                });
                document
                    .querySelector(".form-navigation")
                    .insertBefore(
                        quiz_nav,
                        document.querySelector(".form-navigation").childNodes[2]
                    );
            }
        } else {
            if (document.querySelector("#add-score"))
                document
                    ...
                    .parentNode.removeChild(
                        document.querySelector("#add-score")
                    );
            if (document.querySelector(".score")) {
                [
                    ...document.querySelector(".form-navigation").children,
                ...
                document
                    .querySelector(".score")
                    .parentNode.removeChild(document.querySelector(".score"));
            }
        }
    });
    ...
    const editQuestion = () => {
        document.querySelectorAll(".input-question").forEach((question) => {
            question.addEventListener("input", function () {
                ...
                let required;
                document
                    .querySelectorAll(".input-question-type")
                    .forEach((qp) => {
                        if (qp.dataset.id === this.dataset.id)
                            question_type = qp.value;
                    });
                document
                    .querySelectorAll(".required-checkbox")
                    .forEach((rc) => {
                ...
                fetch("add_choice", {
                    ...
                    .then((result) => {
                        ...
                        document
                            ...
                            .forEach((choices) => {
                                if (
                                    choices.dataset.id === this.dataset.question
                                ) {
                                    choices.insertBefore(
                                        element,
                                        choices.childNodes[
                                            choices.childNodes.length - 2
                                        ]
                                    );
                                    editChoice();
                                    removeOption();
                                ...
                                if (
                                    ...
                                    <div class="choice">
                                        ...
                                        data-type = "${this.value}">Add option</label>
                                            ...
                                            choicesElement.parentNode.replaceChild(
                                                ele,
                                                choicesElement
                                            );
                                            editChoice();
                                    ...
                                    if (this.value === "short") {
                                        choicesElement.parentNode.removeChild(
                                            choicesElement
                                        );
